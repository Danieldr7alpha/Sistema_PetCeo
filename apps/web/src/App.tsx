...
function CustomerRegistrationLinkModal({ onClose }: { onClose: () => void }) {
  ...
  const whatsAppMessage = `Olá! Para finalizar seu agendamento, precisamos que você preencha seu cadastro pelo link abaixo:\n\n${link}\n\nEste link é exclusivo para você, válido por 7 dias e pode ser utilizado somente uma vez. Seus dados serão enviados diretamente para o sistema CEO Pet AI.`;
